...
import ConsulterPourLeProbleme from "./pages/studentPages/ConsulterPourLeProbleme";
                    ...
                    <Routes>
                        ...
                        <Route path="*"
                               element={<h1 className="min-vh-100 text-center text-white display-1 min-vh-100">404 -
                                   Page pas trouvé</h1>}/>
                        <Route path="/consulterPourLeProbleme" element={<ConsulterPourLeProbleme connectedUser={connectedUser} />}></Route>
                    </Routes>
                </BrowserRouter>
            </Container>
        );
