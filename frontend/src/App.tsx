...
import ConsulterPourLeProblemeDeLEntreprise from "./pages/companyPages/ConsulterPourLeProblemeDeLEntreprise";
            ...
            <Container className="min-vh-100">
                <BrowserRouter>
                    <Routes>
                        ...
                        <Route path="/consulterpourleprobleme"
                               element={<ConsulterPourLeProblemeDeLEntreprise connectedUser={connectedUser}/>}/>
                    </Routes>
                </BrowserRouter>
            </Container>
        );
