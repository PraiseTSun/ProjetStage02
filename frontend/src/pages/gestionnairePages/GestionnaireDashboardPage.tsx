    ...
    return (
        <div className="min-vh-100">
            ...
            <Row className="d-flex justify-content-center">
                ...
                <Link to="/consulterEvaluation" className="btn btn-primary mt-3">Consulter l'évaluation</Link>
                <Link to="/consulterEvaluationParEntreprise" className="btn btn-primary mt-3">Consulter l'évaluation par l'entreprise</Link>
            </Row>
        </div>
    );
}
